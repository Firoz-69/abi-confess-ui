      ...
      <div className="max-w-7xl mx-auto px-6 py-16 relative z-10">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-6 justify-center md:justify-start">
              ...
              <a
                ...
                className="group flex items-center gap-4 text-text-secondary hover:text-sakura-500 transition-all duration-300"
              >
                ...
                <div>
                  <p className="font-light text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    Like Me
                  </p>
                </div>
              </a>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-dark-card border border-sakura-500/20 rounded-xl p-6 space-y-3">
              <p className="text-text-secondary text-sm font-light italic leading-relaxed">
                ...
                Every section, every word, every color - chosen with you in
                mind."
              </p>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-text-muted text-sm font-light">
            © 2025 Made with ❤️ for the most amazing person in the world
          </p>
          ...
          <p className="text-text-muted text-sm font-light">
            Valentine's Day 2025 • 14.02.2025
          </p>
        </div>
      </div>
